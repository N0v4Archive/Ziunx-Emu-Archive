...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            layoutManager.layoutDecoratedWithMargins(view, i3, i2, i4, i);
            if (layoutParams.mFullSpan) {
        ...
        return startAfterPadding2 > 0 ? Math.min(layoutState.mAvailable, startAfterPadding2) : i6;
    }
                ...
                if (savedState == null || savedState.mAnchorPosition == -1 || savedState.mSpanOffsetsSize < 1) {
                    ...
                    if (findViewByPosition != null) {
                        ...
                        if (this.mPrimaryOrientation.getDecoratedMeasurement(findViewByPosition) > this.mPrimaryOrientation.getTotalSpace()) {
                            ...
                            OrientationHelper orientationHelper = this.mPrimaryOrientation;
                            anchorInfo.mOffset = z ? orientationHelper.getEndAfterPadding() : orientationHelper.getStartAfterPadding();
                            return true;
                        }
