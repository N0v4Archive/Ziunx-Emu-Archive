    ...
    public static abstract class Adapter {
        ...
        public final void bindViewHolder(ViewHolder viewHolder, int i) {
            ...
            if (RecyclerView.sDebugAssertionsEnabled) {
                ...
                if (viewHolder.itemView.getParent() == null && ViewCompat.isAttachedToWindow(viewHolder.itemView)) {
    ...
    public final class Recycler {
        ...
        void dispatchViewRecycled(ViewHolder viewHolder) {
            ...
            if (RecyclerView.this.mRecyclerListeners.size() > 0) {
                WindowDecorActionBar$$ExternalSyntheticThrowCCEIfNotNull0.m(RecyclerView.this.mRecyclerListeners.get(0));
                throw null;
            }
