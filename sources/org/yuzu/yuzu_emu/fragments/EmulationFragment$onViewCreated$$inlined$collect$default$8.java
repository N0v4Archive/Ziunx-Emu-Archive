...
public final class EmulationFragment$onViewCreated$$inlined$collect$default$8 extends SuspendLambda implements Function2 {
    ...
    /* renamed from: org.yuzu.yuzu_emu.fragments.EmulationFragment$onViewCreated$$inlined$collect$default$8$1, reason: invalid class name */
    /* loaded from: classes.dex */
    public static final class AnonymousClass1 extends SuspendLambda implements Function2 {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                FlowCollector flowCollector = new FlowCollector() { // from class: org.yuzu.yuzu_emu.fragments.EmulationFragment$onViewCreated$.inlined.collect.default.8.1.1
                    ...
                    public final Object emit(Object obj2, Continuation continuation) {
                        ...
                        if (((Number) obj2).intValue() != 0) {
                            ...
                            binding2.drawerLayout.setDrawerLockMode(1);
                            ViewUtils viewUtils = ViewUtils.INSTANCE;
                            binding3 = EmulationFragment.this.getBinding();
                            InputOverlay surfaceInputOverlay = binding3.surfaceInputOverlay;
                            Intrinsics.checkNotNullExpressionValue(surfaceInputOverlay, "surfaceInputOverlay");
                            ViewUtils.hideView$default(viewUtils, surfaceInputOverlay, 0L, 2, null);
                            binding4 = EmulationFragment.this.getBinding();
                            MaterialCardView loadingIndicator = binding4.loadingIndicator;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public EmulationFragment$onViewCreated$$inlined$collect$default$8(LifecycleOwner lifecycleOwner, Lifecycle.State state, Flow flow, Continuation continuation, EmulationFragment emulationFragment) {
        super(2, continuation);
    ...
    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final Continuation create(Object obj, Continuation continuation) {
        return new EmulationFragment$onViewCreated$$inlined$collect$default$8(this.$this_apply, this.$repeatState, this.$this_collect, continuation, this.this$0);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((EmulationFragment$onViewCreated$$inlined$collect$default$8) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
